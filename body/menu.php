<nav class="row col-12 menu">
  ...
  <!-- <a href="Faq.php" class="col-4 col-sm-2 menu-item">
    <li>
      <div class="col-12 menu-line faq"></div>
      <h6>FAQ <span class="menu-line-span">= foire aux questions</span></h6>
    </li>
  </a>
  <a href="Blog.php" class="col-4 col-sm-2 menu-item">
    <li>
      <div class="col-12 menu-line actualite"></div>
      <h6>Actualité <span class="menu-line-span">Toutes les infos sur la route</span></h6>
    </li>
  </a>
  <a href="Contact.php" class="col-4 col-sm-2 menu-item">
    <li>
      <div class="col-12 menu-line contact"></div>
      <h6>Contact <span class="menu-line-span">toutes les coordonnées</span></h6>
    </li>
  </a> -->
</nav>
