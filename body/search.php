<div class="row search">
  ...
  <h2>Calculez le prix de votre <br>certificat d'immatriculation</h2>
  </div>
  <form class="row search-form--home" method="POST" action="Result.php">
  <div class="col-9 col-md-6 mx-auto search-box">
    <div class="row col-12 mx-auto input-group ">
      <div class="col-12 mx-auto search-box--titre">
        <p class="col-10 mx-auto">
        Votre immatriculation
        </p>
      </div>
      	<input class="col-12 form-control search-form mx-auto" style="border:none;" placeholder="AA-123-AA" type="text" name="immatriculation" required><br>
    </div>
  </div>

	<div class="col-9 col-md-6 mx-auto search-box">
		<div class="row col-12 mx-auto input-group ">
			<div class="col-10 mx-auto search-box--titre">
				<p>
				Votre démarche
				</p>
			</div>
			<select class="mx-auto search-form text-center" name="demande">
	...
	<div class="col-9 col-md-6 mx-auto search-box">
		<div class="row col-12 mx-auto input-group ">
			<div class="col-10 mx-auto search-box--titre">
				<p>
				Département <span>(ex: 01, 02, 2A, 2B, 974, 976)</span>
				</p>
			</div>
	<input type="text" class="search-form mx-auto text-center" name="departement" pattern="[0-9,A-B]{2,3}" maxlength="3" minlength="2" required><br>
		</div>
	</div>
	<div class="col-9 col-md-6 mx-auto search-box">
		<div class="row col-12 mx-auto input-group ">
			...
			<select class="mx-auto search-form text-center" name="type">
  ...
  <div class="col-9 col-md-6 mx-auto search-box">
    <div class="row col-12 mx-auto input-group ">
      ...
      <select class="mx-auto search-form text-center" name="modele">
  ...
  <div class="col-9 col-md-6 mx-auto search-box">
    <div class="row col-12 mx-auto input-group ">
      ...
      <select class="mx-auto search-form text-center" name="energie">
...
<input class="mx-auto search-form text-center" type="number" name="cv" max=60 min=1 required><br>
  ...
  <div class="col-11 mx-auto d-flex flex-row justify-content-center my-flex-container search-box mb-5">
    <button type="submit" class="btn btn-primary btn-mg">CALCULER LE TARIF</button>
  </div>
  </form>
</div>
