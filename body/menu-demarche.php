<div class="row demarche-menu commander-secondview d-flex flex-row-reverse my-flex-container">
	...
	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#changement-de-titulaire" href="#Changement-de-titulaire" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			...
			<span class="col-8 menu-box--titre">Changement de titulaire</span>
		</button>
	</div>
	...
	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#changement-de-titulaire" href="#Changement-de-titulaire" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-certificate"></i></span>
			<span class="col-8 menu-box--titre">Immatriculation d'un véhicule neuf</span>
		</button>
	</div>

	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#changement-de-domicile" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-map-marker"></i></span>
			<span class="col-8 menu-box--titre"> Changement de domicile</span>
		</button>
	</div>

	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#demande-de-duplicata" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-clone"></i>
			</span>
			<span class="col-8 menu-box--titre">
	...
	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#changement-de-statut-matrimonial" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-folder"></i></span>
			<br />
			<span class="col-8 menu-box--titre"> Changement de statut matrimonial</span>
		</button>
	</div>


	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#justificatifs-de-domicile" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-file"></i></span>
			<br />
			<span class="col-8 menu-box--titre"> Justificatifs de domicile</span>
		</button>
	</div>


	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#mise-a-la-casse" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-trash-alt"></i></span>
			<br />
			<span class="col-8 menu-box--titre"> Mise à la casse</span>
		</button>
	</div>


	<div class="col-12 col-sm-6 col-lg-6 col-xl-5 menu-box">
		<button type="button" data-toggle="modal" data-target="#slucg" class="row col-10 mx-auto menu-commander  d-flex align-items-center justify-content-center my-flex-container">
			<span class="col-4 menu-box--icon d-flex flex-row justify-content-center my-flex-container mt-3 mb-3"><i class="fas fa-5x fa-eye"></i></span>
			<br />
			<span class="col-8 menu-box--titre"> Savoir lire une carte grise</span>
		</button>
	</div>
</div>
							...
							<div class="vos-demarches--texte1">
								...
								<div class="col-10 mx-auto vos-demarches--texte1---description">
									...
									<p>
										...
										<span class="bcgyellow">(n° XXXX)</span> à modifier. Veuillez vous assurer <span class="bold"> que votre dossier est bien complet</span> en vous référant à la liste de documents nécessaires.
									</p>
									<p>
									...
									<p>
										Des documents supplémentaires sont à fournir pour les véhicules étrangers : l’original du certificat d’immatriculation étranger et sa photocopie, le justificatif de vente, le certificat de conformité, la déclaration de douane 846A pour les
										véhicules hors
						...
						<div class="row col-11 mx-auto commander-box--section">
							<div class="vos-demarches--texte4">
								...
								<div class="col-10 mx-auto  vos-demarches--texte4---description">
									...
									<p>Un formulaire CERFA N°13753*01 de déclaration devra être rempli en cas de vol ou de perte en plus de l’imprimé CERFA N°13750*05. Toutefois, une déclaration de vol doit être faite auprès du commissariat de police ou auprès de la
										gendarmerie
						...
						<div class="row col-11 mx-auto commander-box--section">
							<div class="vos-demarches--texte5">
								...
								<div class="col-10 mx-auto  vos-demarches--texte5---description">
									...
									<p>
										Le professionnel agréé doit remettre un récépissé de prise en charge pour <span class="bold">destruction du véhicule au propriétaire</span> et à la préfecture (accompagné du certificat d’immatriculation pour la préfecture).
										L’immatriculation
						...
						<div class="row col-11 mx-auto commander-box--section">
							<div class="vos-demarches--texte5">
								...
								<div class="col-10 mx-auto vos-demarches--texte5---description">
									...
									<p>
										Dès que votre commande est passée sur www.cgofficiel.fr (paiement en ligne sécurisé), vous devez nous faire parvenir (envoi par courrier suivi de préférence) les éléments constitutifs de votre dossier afin que nous traitions votre demande
										le plus rapidement
										possible.
									</p>
									<p>
									...
									<div class="row">
										<div class="col-sm-12 col-md-6 vos-demarches--img">
											<img class="rounded mx-auto d-block img-fluid" src="asset/img/carte-grise-specimen.jpg" alt="">
										</div>
